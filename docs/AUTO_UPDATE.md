...
curl -LO https://github.com/velo4705/polyglot/releases/latest/download/polyglot-linux-amd64
...
```bash
go install github.com/velo4705/polyglot/cmd/polyglot@latest
```
...
- [GitHub Releases](https://github.com/velo4705/polyglot/releases)
