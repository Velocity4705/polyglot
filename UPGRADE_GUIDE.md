...
```bash
# Linux amd64
curl -LO https://github.com/velo4705/polyglot/releases/download/v1.0.1/polyglot-linux-amd64

# macOS amd64 (Intel)
curl -LO https://github.com/velo4705/polyglot/releases/download/v1.0.1/polyglot-darwin-amd64

# macOS arm64 (Apple Silicon)
curl -LO https://github.com/velo4705/polyglot/releases/download/v1.0.1/polyglot-darwin-arm64

# Windows amd64
curl -LO https://github.com/velo4705/polyglot/releases/download/v1.0.1/polyglot-windows-amd64.exe
```
...
```bash
# Download v1.0.0
curl -LO https://github.com/velo4705/polyglot/releases/download/v1.0.0/polyglot-linux-amd64
...
2. Search [existing issues](https://github.com/velo4705/polyglot/issues)
3. Open a [new issue](https://github.com/velo4705/polyglot/issues/new)
4. Ask in [discussions](https://github.com/velo4705/polyglot/discussions)
